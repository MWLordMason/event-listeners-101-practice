...
let ClickButton = document.getElementById("the-button")
let ClickTotal = document.getElementById("your-total-clicks")
...
ClickButton.addEventListener("click", () => {
    let newValue = Number(ClickTotal.innerText)
    ClickTotal.innerText = newValue + 1
})
